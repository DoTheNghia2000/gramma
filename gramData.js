const grammarData = [
   ...
   {
      title: "という (to iu)",
      badges: ["JLPT N3", "Gọi là / Cái gọi là"],
      meaning: "Dùng để giải thích tên gọi, nhấn mạnh, hoặc nêu sự vật cụ thể.",
      keywords: ["gọi là", "cái gọi là"],
      structure: [
         "N1 という N2"
      ],
      examples: [
      ...
      compare: [
         "『という』 = gọi là, còn 『って』 là dạng rút gọn, thân mật hơn."
      ],
      tip: "という = 'cái gọi là ~'."
   },
];